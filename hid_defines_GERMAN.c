...
KEYBOARD_MEM_TYPE const char keyboardLUT_DE[KEYBOARD_SIZE] ={
    NULL,                               // 0x00
    NULL,                               // 0x01
    NULL,                               // 0x02
    NULL,                               // 0x03
    ...
    ALTGR_MASK|KEY_MINUS,               // 0x5C '\'
    ALTGR_MASK|KEY_9,                   // 0x5D ]
    SHIFT_MASK|KEY_BRACKET_LEFT,        // 0x5E ^
    SHIFT_MASK|KEY_SLASH,               // 0x5F _
    SHIFT_MASK|,KEY_EQUAL               // 0x60 ` NOTE: German keyborad required two keystokes to produce a backtick (space after backtick key)
    KEY_A,                              // 0x61 a
    KEY_B,                              // 0x62 b
    KEY_C,                              // 0x63 c
    KEY_D,                              // 0x66 d
